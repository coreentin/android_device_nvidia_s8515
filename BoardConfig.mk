...
BOARD_KERNEL_CMDLINE := androidboot.hardware=s8515
...
TARGET_RECOVERY_FSTAB := device/nvidia/s8515/rootdir/etc/fstab.ceres
...
BOARD_SEPOLICY_DIRS := device/nvidia/s8515/sepolicy/common \
                       device/nvidia/s8515/sepolicy/raydium \
                       device/nvidia/s8515/sepolicy/product

# Vendor Init
TARGET_INIT_VENDOR_LIB := libinit_s8515
TARGET_LIBINIT_DEFINES_FILE := device/nvidia/s8515/init/init_s8515.c
